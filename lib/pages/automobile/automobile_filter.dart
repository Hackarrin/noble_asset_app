...
import 'package:afritas/utils/bookings/automobile.dart';
...
class AutomobileFilter extends StatefulWidget {
  const AutomobileFilter({Key? key}) : super(key: key);

  @override
  _AutomobileFilterState createState() => _AutomobileFilterState();
}

class _AutomobileFilterState extends State<AutomobileFilter> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: GestureDetector(
          onTap: () async {
            final res = await AutomobileModals.filters(
                      ...
                      child: ListView.builder(
                        itemBuilder: (BuildContext context, int index) {
                          return Padding(
                            ...
                            child: AutomobileItem(item: _data[index]),
                          );
                        },
