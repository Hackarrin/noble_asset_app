...
class ShortletTopDestinations extends StatefulWidget {
  const ShortletTopDestinations({Key? key}) : super(key: key);

  @override
  _ShortletTopDestinationsState createState() =>
      _ShortletTopDestinationsState();
}

class _ShortletTopDestinationsState extends State<ShortletTopDestinations> {
  var selected = 0;
  var location = "";
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Padding(
                      ...
                      child: ShortletItem(item: item, direction: "horizontal"),
                    );
                  },
