...
class CruiseSearch extends StatefulWidget {
  const CruiseSearch({Key? key}) : super(key: key);

  @override
  _CruiseSearchState createState() => _CruiseSearchState();
}

class _CruiseSearchState extends State<CruiseSearch> {
  var selected = 0;
  final data = [
