...
class TwoFa extends StatefulWidget {
  const TwoFa({Key? key}) : super(key: key);

  @override
  _TwoFaState createState() => _TwoFaState();
}

class _TwoFaState extends State<TwoFa> with SingleTickerProviderStateMixin {
  final menus = [
    {"name": "Enable / Disable Biometric", "page": "biometric"},
    {"name": "Device History", "page": "/devices"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Widgets.buildText("Two-Factor Authentication", context,
            isMedium: true),
        elevation: 0,
