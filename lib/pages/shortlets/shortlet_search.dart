...
class ShortletSearch extends StatefulWidget {
  const ShortletSearch({Key? key}) : super(key: key);

  @override
  _ShortletSearchState createState() => _ShortletSearchState();
}

class _ShortletSearchState extends State<ShortletSearch> {
  var selected = 0;
  final data = [
    {"location": "Lagos", "date": "14 - 15 Jan", "guests": "7"},
    {"location": "Lagos", "date": "14 - 15 Jan", "guests": "7"},
    {"location": "Lagos", "date": "14 - 15 Jan", "guests": "7"},
    {"location": "Lagos", "date": "14 - 15 Jan", "guests": "7"},
    {"location": "Lagos", "date": "14 - 15 Jan", "guests": "7"},
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Widgets.buildText(
                                        "${Helpers.formatNumber(item["date"].toString())}, ${item["guests"]} guests",
                                        context,
