...
class HotelCategories extends StatefulWidget {
  const HotelCategories({Key? key}) : super(key: key);

  @override
  _HotelCategoriesState createState() => _HotelCategoriesState();
}

class _HotelCategoriesState extends State<HotelCategories> {
  var selected = 0;
  var _categories = [];
