...
class Automobile extends StatefulWidget {
  const Automobile({Key? key}) : super(key: key);

  @override
  _AutomobileState createState() => _AutomobileState();
}
      ...
      if (arguments != null) {
        try {
          ...
          setState(() {
            ...
            filter["pickupTime"] = "${defaultDate.hour + 1}:00:00";
            filter["dropoffTime"] = "${defaultEndDate.hour + 1}:00:00";
          });
          updateData(null);
