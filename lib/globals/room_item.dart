                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          for (final attribute in item["attributes"])
                            Widgets.buildText(attribute, context,
                                color: "text.secondary", weight: 500, lines: 2),
                        ],
                      ),
                      const SizedBox(
                        height: 15.0,
                      ...
                      if ((num.tryParse(item["largeBed"].toString())?.toInt() ??
                              0) >
                          0)
                        Padding(
                          padding: const EdgeInsets.only(bottom: 8.0),
                      ...
                      if ((num.tryParse(item["roomSize"].toString())?.toInt() ??
                              0) >
                          0)
                        Padding(
                          padding: const EdgeInsets.only(bottom: 8.0),
                      ...
                      for (final amenity in item["amenities"])
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Helpers.fetchIcons(
                                  (Defaults.hotelAmenities[amenity]?["icon"] ??
                                          "")
                                      .toString(),
                                  "solid",
                                  size: 16.0),
                              ...
                              Widgets.buildText(
                                  (Defaults.hotelAmenities[amenity]?["name"] ??
                                          "")
                                      .toString(),
                                  context,
                                  color: "text.secondary",
                              ...
                              child: Row(
                                children: [
                                  ...
                                  GestureDetector(
                                      ...
                                      child: Helpers.fetchIcons("add", "solid",
                        ...
                        onPressed: () {
                          if (roomsSelected.contains(index)) {
                            ...
                            final price = num.tryParse(item["price"].toString())
                                    ?.toDouble() ??
                                0;
                            if (Helpers.handleCalendarEntry([checkin, checkout],
                                    calendar, price, item["id"].toString()) >
                                0) {
                              numRooms[item["name"]] =
