...
class Shortlet extends StatefulWidget {
  const Shortlet({Key? key}) : super(key: key);

  @override
  _ShortletState createState() => _ShortletState();
}

class _ShortletState extends State<Shortlet>
  ...
  Map<String, dynamic> _data = {
    ...
    "generalRules": {
      ...
      "kids": 0,
      "party": 0,
      "paymentMethods": ["card", "visa", "mastercard", "transfer"],
      "pets": 0,
      "smoking": 0
    }
  };
                            ...
                            return GestureDetector(
                              onTap: () {
                                Sheets.showImagePreview(_data["images"] ?? [],
                                    ...
                                    startIndex: index, type: "shortlet");
                              },
