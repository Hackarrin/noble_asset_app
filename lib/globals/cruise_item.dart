...
class CruiseItem extends StatelessWidget {
  const CruiseItem(
      {super.key,
      required this.item,
      this.offset = 0,
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      GestureDetector(
        onTap: () {
          Navigator.pushNamed(context, "/cruise", arguments: jsonEncode(item));
        },
        child: Container(
            ...
            children: [
              ...
              if (direction == "horizontal" &&
                ...
                Container(
                  ...
                  padding: const EdgeInsets.symmetric(
                      horizontal: 10.0, vertical: 5.0),
                  child: Widgets.buildText("New to Noble Assets", context,
                      color: "main.primary"),
                ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Widgets.buildText(
                        "${Helpers.formatNumber(item["occupants"].toString())} people",
                        context,
                        color: "text.secondary")
                  ],
                ),
                Row(
                  spacing: 5.0,
                  children: [
                    Helpers.fetchIcons("cassette-vhs", "solid",
                        color: "main.primary", size: 16.0),
                    Widgets.buildText(item["berths"].toString(), context,
                        color: "text.secondary")
                  ],
                ),
                Row(
                  spacing: 5.0,
                  children: [
                    Helpers.fetchIcons("tachometer-alt-fastest", "solid",
                        color: "main.primary", size: 16.0),
                    Widgets.buildText(item["speed"], context,
                        color: "text.secondary")
                  ],
                )
              ],
