                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Widgets.buildText("Car Brand", context,
                                      weight: 500),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                                        ...
                                        for (var category in (seeMoreBrands
                                          ...
                                          UnconstrainedBox(
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                    color: selectedBrands.contains(category)
                                                        ? Palette.getColor(
                                                            context,
                                                            "background",
                                                            "default")
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Widgets.buildText("Car Specs", context,
                                      weight: 500),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Widgets.buildText("Fuel Type", context,
                                      weight: 500),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                                  SizedBox(
                                    ...
                                    child: Wrap(
                                      ...
                                      children: [
                                        for (var category
                                            in Defaults.automobileFuelTypes)
                                          UnconstrainedBox(
                                            child: GestureDetector(
                                              onTap: () {
                                                ...
                                                decoration: BoxDecoration(
                                                    color: selectedFuelTypes
                                                        ...
                                                        : Palette.getColor(
                                                            context, "background", "paper"),
                                                    border: Border.all(
                                                        color: selectedFuelTypes.contains(category)
                                                            ? Palette.getColor(
                                                                context, "text", "black")
                                                            : Palette.getColor(
                                                                context,
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Widgets.buildText("Mileage", context,
                                      weight: 500),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                                  SizedBox(
                                    ...
                                    child: Wrap(
                                      ...
                                      children: [
                                        for (var category
                                            in Defaults.automobileMileages)
                                          UnconstrainedBox(
                                            child: GestureDetector(
                                              onTap: () {
                                                if (selectedMileages
                                                ...
                                                decoration: BoxDecoration(
                                                    color: selectedMileages
                                                        ...
                                                        : Palette.getColor(
                                                            context, "background", "paper"),
                                                    border: Border.all(
                                                        color: selectedMileages.contains(category)
                                                            ? Palette.getColor(
                                                                context, "text", "black")
                                                            : Palette.getColor(
                                                                context,
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Widgets.buildText("Transmission", context,
                                      weight: 500),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                                  SizedBox(
                                    ...
                                    child: Wrap(
                                      ...
                                      children: [
                                        for (var category
                                            in Defaults.automobileTransmission)
                                          UnconstrainedBox(
                                            child: GestureDetector(
                                              onTap: () {
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Widgets.buildText("Seats", context,
                                      weight: 500),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                                  SizedBox(
                                    ...
                                    child: Wrap(
                                      ...
                                      children: [
                                        for (var category
                                            in Defaults.automobileCapacities)
                                          UnconstrainedBox(
                                            child: GestureDetector(
                                              onTap: () {
