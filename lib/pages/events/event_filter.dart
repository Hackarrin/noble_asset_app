          ...
          Marker marker = Marker(
              ...
              position: LatLng(
                  ...
                  num.tryParse(item["lon"].toString())?.toDouble() ??
                      _center.longitude),
              onTap: () {
                Sheets.showItem(item, type: "event");
              });
          markers.add(marker);
        }
        setState(() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: GestureDetector(
          onTap: () async {
            final res = await EventModals.filters(
        ...
        actions: [
          GestureDetector(
            onTap: () async {
              final res = await EventModals.filterOther(filter, total);
              setState(() {
                filter = res;
              });
            },
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          TextButton(
                              ...
                              child: Widgets.buildText("All Events", context,
