...
class AutomobileCategories extends StatefulWidget {
  const AutomobileCategories({Key? key}) : super(key: key);

  @override
  _AutomobileCategoriesState createState() => _AutomobileCategoriesState();
}

class _AutomobileCategoriesState extends State<AutomobileCategories> {
  var selected = 0;
  var _categories = [];
